  ...
  return {
    ...
    link: function ($scope) {
      ...
      $scope.createShortcut = function () {
        ...
        a.href = "/create-shortcut?name=" + $scope.shortcut.name + "&url=/ZAutomation/api/v1/devices/" + $scope.shortcut.id + "/command/" + $scope.shortcut.command + "&icon=" + $scope.shortcut.iconPath
        a.click();
      }
    }
  }
