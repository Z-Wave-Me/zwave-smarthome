var applang = {
    "newtrans": "---",
     "---": "newtrans",
    "try_restart_raspberry": "Try to restart your Raspberry.",
    ...
    "error_remote_access_init": "Can't to intialize remote access data. Please deactivate/activate it in Apps-Active tab.",
    "patches": "Patches",
    ...
    "error_zwave_network": "An unexpected error occurred while connecting the Z-Wave network.",
    "error_zwave_device": "An unexpected error occurred while loading the Z-Wave device.",
    ...
    "password_email_info": "Please provide the email address in case you loose your password.",
    "replug_device": "Replug the device",
    "ctrl_info_caps_cap_title": "Capabilities:",
    "management_trans_info": "This translation was provided by Z_Wave.Me http://www.zwave.me For contact please use info@zwave.me",
    ...
    "email_notfound": "Given email does not exist in our database",
    ...
    "backup_info": "This will create a file that you can save to your computer.",
    ...
    "are_you_sure_restore": "Are your sure to overwrite the current configuration? Have you created a backup?",
    ...
    "remote_access_not_active": "Remote Access Management is not activated. Please activate it in Apps-Active tab.",
    "remote_access_not_installed": "Remote Access Management is not installed. Please add new 'Remote Access' ( Apps > local > Remote Access > +New App ) app in local Apps.",
    ...
    "lb_email": "E-mail",
    "remote_access_manage": "Remote Access Management",
    ...
    "lb_allow_rooms": "Allow access to rooms",
    ...
    "lb_include_preparation": "The device must be in factory default state. If you are unsure about it, just run the",
    "lb_include_preparation_start": "Exclusion again",
    ...
    "lb_inclusion_progress": "Inclusion process",
    "btn_inclusion_start": "Start inclusion",
    "btn_inclusion_stop": "Stop inclusion",
    "btn_exclusion_start": "Start exclusion",
    "btn_exclusion_stop": "Stop exclusion",
    "btn_back": "Back",
